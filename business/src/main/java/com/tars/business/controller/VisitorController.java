...
public class VisitorController {
    ...
    // 向司法所发送禁止令表，让司法所审核
    @PostMapping("/sfs")
    public void sendToSFS(@RequestBody VisitorInfo ban) {
    ...
    public void sfsSendToJzjg(@RequestBody VisitorInfo ban) {
    ...
    // 发送社区矫正机构的信息
    @PostMapping("/jzjg")
    public void sendToJZJG(@RequestBody VisitorInfo ban) {
        System.out.println(ban);
